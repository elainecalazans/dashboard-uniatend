...
def gerar_html_report(
    ...
    cta_dashboard = (
        ...
        f"<table cellspacing='0' cellpadding='0' style='margin:0 auto;'><tr>"
        f"<td style='background:#005f5f;border-radius:6px;'>"
        f"<a href='{dashboard_url}' style='display:inline-block;color:#ffffff;"
        f"font-weight:700;font-size:13px;text-decoration:none;padding:11px 28px;"
        f"letter-spacing:.3px;'>Acessar o Dashboard &rarr;</a>"
        f"</td></tr></table>"
        f"</div>"
